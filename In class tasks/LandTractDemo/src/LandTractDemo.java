 ...
 * In Class Task #9
 * This is the main method of the java program, not subject to change per instructions. This class includes methods to read input from a user, create land tract objects, and display information
 */
